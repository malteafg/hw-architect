...
pub struct MainRenderer {
    ...
    pub terrain_renderer: renderer::terrain_renderer::TerrainState,
...
pub trait RenderMain<'a> {
    fn render_main(&mut self, main_renderer: &'a MainRenderer);
}
    ...
    'b: 'a,
{
    fn render_main(&mut self, main_renderer: &'a MainRenderer) {
        ...
        self.set_pipeline(&main_renderer.light_render_pipeline);
        self.draw_light_model(
            &main_renderer.obj_model,
            &main_renderer.camera_bind_group,
            &main_renderer.light_bind_group,
        );
    }
}
